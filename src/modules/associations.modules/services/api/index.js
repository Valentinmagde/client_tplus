//import axios from "@/services/http/axios-config.js"

import axios from "@/axios"
import http_service from "./httpService"

export const fetchUserAssociationApi = (credentials) => axios.get(`/api/associations/user/${credentials.userUUID}`)

export const assocationRolesApi = (credentials) => axios.get("api/association/"+credentials.association+"/user/"+credentials.user+"/roles")


export const postRequest = ({commit}, payload) => {
  return http_service.post({commit}, payload)
}

export const fetchUserAssociation = ({ commit }, payload) => {
  return http_service.get({commit}, payload)
}

export const removeRecord = ({ commit }, payload) => {
