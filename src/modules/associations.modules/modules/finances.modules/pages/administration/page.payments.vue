      ...
      <div>
        <vx-card class="mb-base">
          ...
          <p class="mt-2 text-muted">
            {{ $t("listOfSettlementAndDebtsAdmin") }}
          </p>
        </vx-card>
                ...
                <template slot-scope="{ data }">
                  <vs-tr :key="indextr" v-for="(echeance, indextr) in data">
                    <vs-td :data="data[indextr].membre">
                      <span class="product-name font-medium truncate">
                        {{ data[indextr].membre }}
                      </span>
                    </vs-td>
  ...
  computed: {
    ...
    echeancesData() {
      ...
      if (data2.length > 0) {
        data2.forEach((dette) => {
          let dettes =
            dette.statistique.dettes_cotisations +
            dette.statistique.dettes_acquitements;
          if (dettes > 0)
            echeances.push({
                ...
                this.$store
                  ...
                  .then((res) => {
                    ...
                    donnees.forEach((element) => {
                      this.dette +=
                        element.statistique.dettes_cotisations +
                        element.statistique.dettes_acquitements;
                    });
                  })
                  .catch((error) => {
