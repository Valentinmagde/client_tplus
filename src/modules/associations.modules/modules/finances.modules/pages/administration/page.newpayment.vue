...
<div>
    ...
    <div class="pt-16">
        <vx-card class="mb-6">
            <h5>{{$t('saveAPayment') | CAPITALIZE }}</h5>
        ...
        <vx-card>
            <div class=" clearfix mr-auto max-w-3xl">
                ...
                <!-- Numéro de bordereau ou du reçu -->
                        ...
                        <div class="flex wrap justify-end">
                            <div class="vx-col sm:w-1/2 w-full">
                                <div class="text-center">
                                    <span>
                                        <h6 class="font-bold text-lg" :class="{redtextclass: montant < 0}">
                    ...
                    <div class="vx-col sm:w-1/2 w-full mb-base">
                            ...
                            <div class="vx-col sm:w-1/4 w-full">
                                ...
                                <span 
                                    ...
                                    <feather-icon 
                                        ...
                                        style="color:red;" 
                                        svgClass="h-1" @click="remove(k, input.montant)" v-show="k || (!k && inputs.length > 1)">
                                    </feather-icon>
                                </span>
                            </div>
                        </div>
                        <div class="vx-col w-full">
                            <ul class="inline-block" style="color:#65B0F3;">
                                <li 
                                    color="#65B0F3" 
                                    class="inline-block hover:italic cursor-pointer mb-1" 
    ...
    computed: {
        ...
        validateForm() {
            if(this.inputs[this.inputs.length - 1])
              return (this.compte != '' && this.montant != '' &&
