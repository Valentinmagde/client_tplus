    ...
    export default {
      props: ['activity'],
        ...
        mounted(){
            ...
            // this.type_processus = localStorage.getItem('activity_id') !== null ? 'modification' : this.type_processus
        },
        methods: {
            previous(){
                ...
                if(localStorage.getItem('activity_id') !== null){
                    ...
                    let payload = {
                        ...
                        data: {
                            ...
                            type_penalite: activite_courante.type_penalite ?activite_courante.type_penalite.value: null,
