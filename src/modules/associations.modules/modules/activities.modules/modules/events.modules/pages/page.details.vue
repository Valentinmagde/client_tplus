<template>
  <div id="data-list-list-views" class="data-list-container">
    <!-- ACTION - DROPDOWN -->
    ...
    <div class="pt-16">
      <vx-card class="mb-base">
        ...
        <div class="vx-row mt-4">
          <!-- Date de création -->
          <div
            v-if="activite_courante.Evenement != null"
            class="vx-col sm:w-full md:w-auto w-auto items-center mb-2"
          >
            <span class="inline-block">Date:</span>
            <span class="ml-1 font-semibold">{{
              activite_courante.Evenement.date_event | dateTime
            }}</span>
          ...
          <div
            ...
            class="vx-col sm:w-full md:w-auto w-auto items-center mb-2"
          >
            <span class="inline-block">{{ $t("location") }}:</span>
            <span class="ml-1 font-semibold">{{
              activite_courante.Evenement.lieu_event
            }}</span>
          ...
          <div
            ...
            class="vx-col sm:w-full md:w-auto w-auto items-center mb-2"
          >
            <span class="inline-block">{{ $t("hour") }}:</span>
            <span class="ml-1 font-semibold">{{
              eventTime(activite_courante.Evenement.date_event)
            }}</span>
          </div>
        </div>
      </vx-card>
...
export default {
  ...
  methods: {
    ...
    //Retourner la date en fonction de la langue
    eventTime(date_time) {
      return new Date(date_time * 1000).toLocaleString(this.$t("lang"), {
        hour: "numeric",
        minute: "numeric",
      });
    },
    ...
    redirectTransactions(account) {
      ...
      if (this.admin)
        this.$router.push(
          "/association/administration/activities/event/member-transactions"
        );
      else
        this.$router.push("/association/activities/event/member-transactions");
    },
        ...
        .then((res) => {
          ...
          comptes.forEach((element) => {
            ...
            if (element.membres_id == this.membre_id) {
              this.transactions_membre = element.transactions;
