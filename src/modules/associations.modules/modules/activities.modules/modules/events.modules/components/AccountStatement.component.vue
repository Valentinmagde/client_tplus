<template>
    <div id="data-list-list-view" class="data-list-container">
        ...
        <!-- <div class="overflow-auto"> -->
          <vs-table v-if="comptesData.length > 0" ref="table" pagination :max-items="itemsPerPage" :data="comptesData" search class="table w-full">
                ...
                <template slot-scope="{data}">
                    <vs-tr v-for="member in data" :key="member.id" @click="selectMember(event, member.id)">
                        <vs-td>
        ...
        <!-- </div> -->
        <div class="flex flex-wrapper ml-4">
            <vs-button
                type="border"
                class="mr-6"
