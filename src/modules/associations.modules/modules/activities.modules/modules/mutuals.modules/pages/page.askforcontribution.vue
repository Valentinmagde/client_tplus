<template>
    <div>
        ...
        <div class="pt-16">
            <vx-card class="mr-4" no-shadow :title="$t('requestForContribution').toUpperCase()+' - '+nom_activite">
...
import checkActivityType from '../../../mixins/checkActivityType'
    ...
    export default {
        mixins: [checkRole, checkActivityType],
        data(){
            return{
                selected: [],
                montant: '',
        ...
        computed : {
            ...
            validateForm() {
                return this.montant != '' && this.date_limite_versement !='' && this.frequence !='' && this.radios !=''
            },
        },
        methods: {
            filterKey(e){
                ...
                if(this.activity !== ''){
                    ...
                    if(this.frequence.value == 'UNEFOIS') {
                        ...
                        .then(() => {
                            ...
                            this.$router.push('/association/administration/activities/mutual/details')
                        })
                        .catch(error => {
                            this.$vs.notify({
                                position:'top-center',
         ...
         created(){
            ...
            .then((result) => {
              this.checkActivityType(result.data.data)
              this.nom_activite = result.data.data.nom
                let payload = {
