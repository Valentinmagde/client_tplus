        ...
        <div class="vx-row mt-4">
          ...
          >
            <span class="inline-block font-semibold"
              >{{ $t("Penaltyrate") }}:</span
            >
            <span class="ml-1">{{ activite_courante.taux_penalite }}%</span>
          ...
          <div class="vx-col sm:w-full md:w-auto w-auto items-center mb-2">
            ...
            <span
              ...
              :class="{
                redtextclass:
                  activite_courante.Solidarite.montant_fond_solidarite < 0,
              }"
            >
              {{
                activite_courante.Solidarite.montant_fond_solidarite
                  | formatMoney(devise)
              }}
            </span>
          ...
          <div class="vx-col sm:w-full md:w-auto w-auto items-center mb-2">
            <span class="inline-block font-semibold"
              >{{ $t("upgradeDeadlines") }}:</span
            >
            <span class="ml-1">
              {{ activite_courante.Solidarite.delai_mise_a_niveau }}
              {{ $t("generalMeetings") }}
            </span>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    redirectTransactions(account) {
      ...
      if (this.admin)
        this.$router.push(
          "/association/administration/activities/solidarity/member-transactions"
        );
      else
        this.$router.push(
          "/association/activities/solidarity/member-transactions"
        );
    },
