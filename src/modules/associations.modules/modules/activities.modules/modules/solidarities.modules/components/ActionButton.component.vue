...
<div>
    <vs-dropdown vs-trigger-click class="ml-auto md:block cursor-pointer fixed z-50" style="right:35px">
        ...
        <vs-dropdown-menu style="width: 13rem">
            <!-- Tableau de bord -->
            <vs-dropdown-item>
                <div class="flex items-center" @click="$router.push('/association/administration/activities/solidarity/details').catch(() => {})">
            ...
            <!-- Echéances -->
            <vs-dropdown-item>
                <div class="flex items-center" @click="$router.push('/association/administration/activities/solidarity/settlements').catch(() => {})">
            ...
            <!-- Impayés -->
            <vs-dropdown-item>
                <div class="flex items-center" @click="$router.push('/association/administration/activities/solidarity/debt').catch(() => {})">
                    <!-- <feather-icon icon="CircleIcon" class="inline-block mr-2" svgClasses="w-4 h-4" /> -->
                    <span>{{$t('debt')}}</span>
                </div>
            </vs-dropdown-item>
            ...
            <!-- Notes -->
            <vs-dropdown-item>
                <div class="flex items-center" @click="$router.push('/association/administration/activities/solidarity/notes').catch(() => {})">
                    <!-- <feather-icon icon="CircleIcon" class="inline-block mr-2" svgClasses="w-4 h-4" /> -->
                    <span>{{$t('notes')}}</span>
                </div>
            </vs-dropdown-item>
            ...
            <!-- Declarer une assistance -->
            <vs-dropdown-item v-if="etat_activite != 'cloture'">
                <div class="flex items-center" @click="$router.push('/association/administration/activities/solidarity/assistance').catch(() => {})">
            ...
            <vs-dropdown-item v-if="etat_activite != 'cloture'">
                <div @click="$router.push('/association/administration/activities/solidarity/ask-for-contribution').catch(() => {})" class="flex items-center">
            ...
            <vs-dropdown-item>
                <div @click="$router.push('/association/administration/activities/solidarities/all').catch(() => {})" class="flex items-center">
    ...
    methods: {
        ...
        redirectTransactions() {
          ...
          .then((res) => {
            ...
            this.$router.push('/association/administration/activities/solidarity/member-transactions')
